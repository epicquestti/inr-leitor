...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var notificationQueryBuilder, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    notificationQueryBuilder = _a.sent();
                    return [4 /*yield*/, notificationQueryBuilder
                            .update()
                            .set({
                            readed: true
                        })
                ...
                case 2:
                    ...
                    return [4 /*yield*/, electron_1.shell.openExternal(data.link)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
