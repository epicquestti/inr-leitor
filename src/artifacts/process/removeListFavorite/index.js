...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var favoriteRepository, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!data)
                        throw new Error("Voce não selecionou nenhum item.");
                    if (data.length <= 0)
                        throw new Error("Voce não selecionou nenhum item.");
                    return [4 /*yield*/, db.getRepository(Entities_1.Favoritos)];
                case 1:
                    favoriteRepository = _a.sent();
                    return [4 /*yield*/, favoriteRepository["delete"]({ id: (0, typeorm_1.In)(data) })];
                case 2:
                    _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    return [2 /*return*/, event === null || event === void 0 ? void 0 : event.sender.send("resolveAction", {
                            action: "msg",
