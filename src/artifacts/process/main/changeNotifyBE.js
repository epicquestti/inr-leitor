    ...
    handle: function (db, data, event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    configRepository = _a.sent();
                    return [4 /*yield*/, configRepository.save({
                            id: 1,
                            notifyBoletim: data
                        })
                ...
                case 3:
                    error_1 = _a.sent();
                    event === null || event === void 0 ? void 0 : event.sender.send("responseNotifyBE", {
                        success: false,
                        msg: error_1
                    });
                    return [3 /*break*/, 4];
...
//# sourceMappingURL=changeNotifyBE.js.map