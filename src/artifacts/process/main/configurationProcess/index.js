...
function configurationProcess(db) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    consfigRepository = _a.sent();
                    return [4 /*yield*/, consfigRepository.createQueryBuilder("configuracoes")];
                case 2:
                ...
                case 3:
                    ...
                    if (!!configResult) return [3 /*break*/, 7];
                    return [4 /*yield*/, (0, lib_1.stringGenerator)("inrAppID:")];
                case 4:
                    instaName = _a.sent();
                    return [4 /*yield*/, (0, lib_1.GET)(app_1["default"].api.inr.lastPublishes)];
                case 5:
                    lastPublications = _a.sent();
                    newConfig = {
                        id: 1,
                    ...
                    return [4 /*yield*/, configQueryBuilder.insert().values([newConfig]).execute()];
                case 6:
                    _a.sent();
                    _a.label = 7;
...
exports["default"] = configurationProcess;
