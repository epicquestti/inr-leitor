...
var verifyBoletins = function (db, iconPath, appVersion) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, getConfigurations_1["default"])(db)];
            case 2:
                appConfig = _a.sent();
                if (!(appConfig && lastPublishes)) return [3 /*break*/, 9];
                return [4 /*yield*/, lib_1.versionTools.compareVersions(appVersion, lastPublishes.version)];
            case 3:
            ...
            case 5:
                ...
                return [4 /*yield*/, (0, processTray_1["default"])(iconPath, beProcessResult, clProcessResult)];
            case 6:
                _a.sent();
                _a.label = 7;
...
exports["default"] = verifyBoletins;
