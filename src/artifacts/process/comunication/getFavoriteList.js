...
exports["default"] = {
    ...
    handle: function (db, data, event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    allFavListRepository = _a.sent();
                    return [4 /*yield*/, allFavListRepository.find({
                            order: {
                                idFavorito: "DESC"
                            }
                        })];
                case 2:
                    ...
                    if (!(allFavListResponse.length > 0)) return [3 /*break*/, 7];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, boletimRepository.find({
                            where: [
                                { title: (0, typeorm_1.ILike)("%".concat(data.searchText, "%")) },
                ...
                case 7: return [2 /*return*/, event.sender.send("reloadFavoritos", [])];
...
//# sourceMappingURL=getFavoriteList.js.map