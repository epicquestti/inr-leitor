...
exports["default"] = {
    ...
    handle: function (db, event) { return __awaiter(void 0, void 0, void 0, function () {
        var notificacoesQueryBuilder, notificationList, notificationCount, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, event.sender.send("reloadNotificationList", {
                            success: true,
                            data: {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.log(error_1);
                    event === null || event === void 0 ? void 0 : event.sender.send("reloadNotificationList", {
                        success: false,
                        msg: error_1
                    });
                    return [3 /*break*/, 5];
