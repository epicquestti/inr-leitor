...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var searchText, page, limit, classificadorRepository, count, response, filterResults, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_1 = _a.sent();
                    event === null || event === void 0 ? void 0 : event.sender.send("realodClassificadoresList", false);
                    return [3 /*break*/, 5];
...
//# sourceMappingURL=getClassificadoresList.js.map