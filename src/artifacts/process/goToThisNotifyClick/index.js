...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var beRepository, nt, goTo, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (nt.type === "B") {
                        goTo = "/boletim/".concat(nt.id);
                    }
                    if (nt.type === "C") {
                        goTo = "/classificador/".concat(nt.id);
                    }
                    if (nt.type === "U") {
                        goTo = nt.link;
                    }
                    return [2 /*return*/, event.sender.send("goToNotificationAction", {
                            success: true,
                            data: {
                                goTo: goTo,
                                notificacao: nt,
                ...
                case 3:
                    error_1 = _a.sent();
                    console.log(error_1);
                    event === null || event === void 0 ? void 0 : event.sender.send("goToNotificationAction", {
                        success: false,
                        msg: error_1
                    });
                    return [3 /*break*/, 4];
