...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var boletimRepository, boletimQueryBuilder, count, response, filterResults, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, boletimRepository.createQueryBuilder("boletins")];
                case 2:
                    boletimQueryBuilder = _a.sent();
                    return [4 /*yield*/, boletimQueryBuilder.update().set({ read: data.readState }).execute()];
                case 3:
                    _a.sent();
