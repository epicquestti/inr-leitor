...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var notificacoesQueryBuilder, notificationGrid, responseArray, i, notificationList, notificationCount, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, notificacoesQueryBuilder.update().set({ readed: true }).execute()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, notificacoesQueryBuilder
                            ...
                            .getMany()];
                case 3:
                    notificationGrid = _a.sent();
                    responseArray = [];
                    for (i = 0; i < notificationGrid.length; i++) {
                        responseArray.push({
