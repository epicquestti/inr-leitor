...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var notificacoesRepository, notificationSelected, notificationList, responseArray, i, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    notificationSelected = _a.sent();
                    if (data.actionName === "lookThis") {
                        return [2 /*return*/, event.sender.send("notificationSendToTarget", {
                                success: true,
                                data: __assign({}, notificationSelected)
                            })];
                    }
                    if (data.actionName === "readThis")
                        notificationSelected.readed = true;
                    if (data.actionName === "unreadThis")
                        notificationSelected.readed = false;
                    return [4 /*yield*/, notificacoesRepository.save(notificationSelected)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, notificacoesRepository
                            .createQueryBuilder()
                ...
                case 4:
                    ...
                    return [2 /*return*/, event.sender.send("reloadNotificationGrid", {
                            success: true,
                            data: {
