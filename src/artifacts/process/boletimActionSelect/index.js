...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var boletimRepository, boletimSelected, count, response, filterResults, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, boletimRepository.findOne({
                            where: {
                                id: data.id
                            }
                        })];
                case 2:
                    boletimSelected = _a.sent();
                    if (data.actionName === "lookThis") {
                        return [2 /*return*/, event.sender.send("boletimSendToTarget", {
                                success: true,
                                data: boletimSelected.id
                            })];
                    }
                    if (data.actionName === "readThis")
                        boletimSelected.read = "S";
                    if (data.actionName === "unreadThis")
                        boletimSelected.read = "N";
                    return [4 /*yield*/, boletimRepository.save(boletimSelected)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, boletimRepository.count({
                            where: {
                ...
                case 5:
                    ...
                    return [2 /*return*/, event.sender.send("realodBoletimList", {
                            count: count,
                            data: filterResults
                        })];
                case 6:
                    error_1 = _a.sent();
                    event === null || event === void 0 ? void 0 : event.sender.send("realodBoletimList", {
                        success: false,
                        msg: error_1
                    });
                    return [3 /*break*/, 7];
