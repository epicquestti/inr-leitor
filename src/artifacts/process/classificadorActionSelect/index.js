...
exports["default"] = {
    ...
    handle: function (db, event, data) { return __awaiter(void 0, void 0, void 0, function () {
        var classificadorRepository, classificadorSelected, count, response, filterResults, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, classificadorRepository.findOne({
                            where: {
                                id: data.id
                            }
                        })];
                case 2:
                    classificadorSelected = _a.sent();
                    if (data.actionName === "lookThis") {
                        return [2 /*return*/, event.sender.send("classificadorSendToTarget", {
                                success: true,
                                data: classificadorSelected.id
                            })];
                    }
                    if (data.actionName === "readThis")
                        classificadorSelected.read = "S";
                    if (data.actionName === "unreadThis")
                        classificadorSelected.read = "N";
                    return [4 /*yield*/, classificadorRepository.save(classificadorSelected)];
                case 3:
                    _a.sent();
